...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_black, col_gray3, col_gray3 },
};

/* tagging */
static const char *tags[] = { "E", "R", "S", "D", "F", "Z", "X", "C", "V" };
...
//	{ MODKEY|ShiftMask,             XK_space,  togglefloating, {0} }, // mouseit
